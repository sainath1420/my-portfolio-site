...
import { Home, User, Briefcase, Code2, Award, Mail, Menu, X, FileDown, Github, Linkedin } from "lucide-react";
...
const SidebarNav = () => {
  ...
  const NavContent = () => (
    <>
      <div className="mb-8">
        <a href="#home" className="font-heading text-xl font-black text-primary tracking-tight">
      ...
      <div className="mt-auto pt-6 border-t border-border space-y-3">
        ...
        <p className="text-[11px] text-muted-foreground truncate">kasisainath14@gmail.com</p>
        <a
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside className="hidden lg:flex fixed left-0 top-0 bottom-0 w-48 z-40 flex-col p-5 border-r border-border bg-background/95 backdrop-blur-sm">
        <NavContent />
      </aside>
